...
#include "AkSwitch2InitializationSettings.generated.h"

UCLASS(config = Game, defaultconfig)
class AKAUDIO_API UAkSwitch2InitializationSettings : public UAkPlatformInitializationSettingsBase
{
	GENERATED_BODY()
...
public:
	...
	UAkSwitch2InitializationSettings(const FObjectInitializer& ObjectInitializer);
...
UCLASS()
class AKAUDIO_API UAkSageInitializationSettings : public UAkSwitch2InitializationSettings
{
	GENERATED_BODY()
};