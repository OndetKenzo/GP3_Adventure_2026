...
class AKAUDIO_API UAkSwitchInitializationSettings : public UAkPlatformInitializationSettingsBase
{
	GENERATED_BODY()
...
public:
	...
	UAkSwitchInitializationSettings(const FObjectInitializer& ObjectInitializer);
