...
public class WwiseUEPlatform_2022_1_Switch : WwiseUEPlatform
{
	public WwiseUEPlatform_2022_1_Switch(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
