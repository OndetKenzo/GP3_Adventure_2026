...
public class WwiseUEPlatform_2024_1_PS5 : WwiseUEPlatform
{
	public WwiseUEPlatform_2024_1_PS5(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
	...
	{ 
		get 
		{
			...
			Version Expected = new Version(ExpectedSdkVersion);
			Version Minimum = new Version("9.000");
			if (Expected > Minimum)
			{
...
public class WwiseUEPlatform_2024_1_DPX : WwiseUEPlatform_2024_1_PS5
{
	public WwiseUEPlatform_2024_1_DPX(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) { }
}